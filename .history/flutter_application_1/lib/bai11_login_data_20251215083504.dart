...
class Bai11UserScreen extends StatefulWidget {
  const Bai11UserScreen({super.key});

  @override
  State<Bai11UserScreen> createState() => _Bai11UserScreenState();
}

class _Bai11UserScreenState extends State<Bai11UserScreen> {
  List<User> _users = [];
  ...
  Future<void> _fetchUsers() async {
    // API miễn phí cung cấp danh sách 10 người dùng mẫu
  ...
  Widget _buildUserCard(User user) {
    // Tạo màu ngẫu nhiên cho Avatar dựa trên ID người dùng
    ...
    return Card(
      ...
      child: ListTile(
        ...
        // Avatar tròn chứa chữ cái đầu của tên
        leading: CircleAvatar(
          radius: 28,
          backgroundColor: avatarColor,
          child: Text(
            user.name[0], // Lấy ký tự đầu tiên của tên
