...
// ---------------------------------------------------------------------------
// 1. MODEL: Class để xử lý dữ liệu JSON
// ---------------------------------------------------------------------------
class User {
  final int id;
  ...
  // Các object con (Address, Company, Bank)
  ...
  // Hàm factory để chuyển JSON thành Object User
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      ip: json['ip'],
      // Xử lý dữ liệu lồng nhau (Nested JSON)
...
// ---------------------------------------------------------------------------
// 3. LOGIN PAGE (Đã cập nhật logic điều hướng)
// ---------------------------------------------------------------------------
...
class _LoginPageState extends State<LoginPage> {
  ...
  // Dữ liệu giả lập (Hardcode JSON bạn cung cấp)
  final Map<String, dynamic> mockApiResponse = {
    ...
    "password": "emilyspass",
    "birthDate": "1996-5-30",
    "image": "https://dummyjson.com/icon/emilys/125",
    "bloodGroup": "O-",
    "height": 193.24,
    "weight": 63.16,
    "eyeColor": "Green",
  ...
  void _handleLogin() {
    if (_formKey.currentState!.validate()) {
      // Giả lập loading 1 giây rồi chuyển trang
      ...
      Future.delayed(const Duration(seconds: 1), () {
        // Parse dữ liệu JSON thành Object User
...
// ---------------------------------------------------------------------------
// 4. USER INFO PAGE (Màn hình hiển thị thông tin)
// ---------------------------------------------------------------------------
class UserInfoPage extends StatelessWidget {
  ...
  // Widget con để tạo Card bao bọc các nhóm thông tin
  ...
  // Widget con để tạo từng dòng thông tin (Icon - Label - Value)
