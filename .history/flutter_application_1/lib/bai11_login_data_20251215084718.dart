...
// ===================================================
// 1. MODEL: Khuôn đúc dữ liệu chi tiết
// ===================================================
class UserProfile {
  final String firstName;
  final String lastName;
  final String image;
  final String title; // Chức vụ (Sales Manager...)
  ...
  // Hàm lấy dữ liệu từ API DummyJSON
  factory UserProfile.fromJson(Map<String, dynamic> json) {
    return UserProfile(
      firstName: json['firstName'],
      lastName: json['lastName'],
      image: json['image'],
      title: json['company']['title'], // Chức vụ nằm trong object company
...
class Bai11ProfileScreen extends StatefulWidget {
  const Bai11ProfileScreen({super.key});
...
class _Bai11ProfileScreenState extends State<Bai11ProfileScreen> {
  UserProfile? _user; // Biến chứa dữ liệu User
  ...
  Future<void> _fetchUserData() async {
    // API này cung cấp đầy đủ thông tin y hệt thiết kế
    // Mình lấy user số 2 làm ví dụ (bạn có thể đổi số khác)
